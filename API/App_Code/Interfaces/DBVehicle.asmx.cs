...
namespace VLF.ASI.Interfaces
{
    ...
    public class DBVehicle : System.Web.Services.WebService
    {
        ...
        public int UpdateVehicleInfo(int userId, string SID, string oldLicensePlate,
                                    ...
                                    bool notify, bool warning, bool critical, bool autoAdjustDayLightSaving, bool maintenance)
        {
            try
            {
                         ...
                         string field1, string field2, string field3, string field4, string field5)
        {
            try
            {
                Log(">>UpdateVehicleAdditionalInfo(uid={0}, vId={1}, field1={2}, field2={3}, field3={4}, field4={5})",
                            userId, vehicleId, field1, field2, field3, field4);
                // Authenticate & Authorize
                ...
                using (Vehicle dbVehicle = new Vehicle(LoginManager.GetConnnectionString(userId)))
                {
                    dbVehicle.UpdateVehicleAdditionalInfo(vehicleId, field1, field2, field3, field4, field5);
                }
        ...
        public int AddVehicle(int userId, string SID, string vinNum, int makeModelId, short vehicleTypeId,
                              ...
                              bool notify, bool warning, bool critical, bool autoAdjustDayLightSaving, bool maintenance, ref Int64 vehicleId)
        {
            try
            {
