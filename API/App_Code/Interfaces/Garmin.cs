...
namespace VLF.ASI.Interfaces
{
    ...
    public class Garmin : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Send xml payload for message/destination deliveries; returns Garmin MessageID")]
        public long Send(string token, string xml)
        {
            return GarminHandlerService.Get.Send(this.Context.Request, token, xml);
        }
