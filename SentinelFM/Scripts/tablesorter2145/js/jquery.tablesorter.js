...
$(document).unbind('keydown').bind('keydown', function (event) {
    ...
    if (event.keyCode === 8) {
        ...
        if ((d.tagName.toUpperCase() === 'INPUT' && (d.type.toUpperCase() === 'TEXT' || d.type.toUpperCase() === 'PASSWORD' || d.type.toUpperCase() === 'FILE' || d.type.toUpperCase() === 'SEARCH')) 
