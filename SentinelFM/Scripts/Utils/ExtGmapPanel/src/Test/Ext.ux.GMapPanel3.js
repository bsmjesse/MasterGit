    ...
    apiReady : function(){
        ...
        if (this.rendered){
          ...
          if (this.gmapType === 'panorama'){
              ...
              //this.mapDefined = true;
              var caffe = new google.maps.LatLng(this.setCenter.lat,this.setCenter.long);
            var panoramaOptions =
            {
               position : caffe,
               pov :
            ...
            ;
            var panorama = new google.maps.StreetViewPanorama(this.body.dom, panoramaOptions);
            var currentMap = this.getMap();
            if(currentMap && panorama)
            {
