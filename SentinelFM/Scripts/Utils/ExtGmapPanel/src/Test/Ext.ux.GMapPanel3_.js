...
Ext.ux.GMapPanel = Ext.extend(Ext.Panel,
{
      ...
      if (this.rendered)
      {
         ...
         (function()
         {
            ...
            if (this.gmapType === 'map')
            {
               ...
               {
                  zoom : this.zoomLevel, mapTypeId : google.maps.MapTypeId.ROADMAP
               }
               );
            ...
            if (this.gmapType === 'panorama')
            {
               ...
               // new GStreetviewPanorama(this.body.dom);
               this.mapDefined = true;
            }
            ...
            if (typeof this.setCenter === 'object')
            {
               ...
               if (this.gmapType === 'panorama')
               {
                  ...
                  {
                     yaw : this.yaw, pitch : this.pitch, zoom : this.zoomLevel
                  }
                  );
               }
            }
   ...
   */
   ...
   {
      for (var i = 0; i < this.cache.infowindow.length;
      i ++ )
      {
