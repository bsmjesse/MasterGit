...
<head>
    ...
    <style type="text/css">
        ...
        .mapsearchtoolbar {
            ...
            position: absolute;
            top: 8px;
            left: 175px; /*width: 450px; height: 35px;*/
        }
        ...
        @media print {
            #alarmpage, .searchAddressBtn, .mapsearchtoolbar, .olbsmtoolbar, .olControlPanZoomBar, .olControlLayerSwitcher, .olControlMousePosition {
