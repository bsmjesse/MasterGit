<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmviewlandmark.aspx.cs" Inherits="SentinelFM.GeoZone_Landmarks_New_frmviewlandmark" meta:resourcekey="PageResource1" %>
...
<body topmargin="0px" leftmargin="0px" >
    ...
    <div  style="vertical-align:top">
          <table border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%">
            ...
            OnClientClick="window.close()"   runat="server" Text="Close" meta:resourcekey="cmdCLoseWindowResource1" 
             />
