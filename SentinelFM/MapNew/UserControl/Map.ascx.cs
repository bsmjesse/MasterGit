...
{
public partial class MapNew_UserControl_Map : System.Web.UI.UserControl
{
    ...
    public string LankMarkData = string.Empty;
    ...
    public double lat=48.423457;
    public double lon=-101.887695;
    public Int16  zoomLevel = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
	  ...
	  //HQ Default Map Settings
        ...
        if (!IsPostBack)
        {
            ...
            LankMarkData = DrawLandMark();
            if (LankMarkData != "") hasLandmarks = "1";
            GeoData = DrawGeoZone();
            ...
            (sn.DsLandMarks.Tables[0].Rows.Count > 0))
        {
            ...
            foreach (DataRow dr in sn.DsLandMarks.Tables[0].Rows)
            {
                ...
                { 
                    ...
                    DataRow[] dtPoints = sn.Landmark.DsLandmarkPointDetails.Select("LandmarkName='" + pointsLandmarkName + "'");
                    if (dtPoints != null)
                    {
