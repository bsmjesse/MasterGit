<%@ Page Language="C#"  CodeFile="NewMessage.aspx.cs" Inherits="SentinelFM.NewMessage" AutoEventWireup="true" UICulture="auto" meta:resourcekey="PageResource1" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    ...
	    function OnLoad() {
	        ...
	        document.getElementById("rcbToGroup").style.width = (wDim.width - 175).toString() + "px";
	        document.getElementById("rcbRecipient").style.width = (wDim.width - 175).toString() + "px";
...
//	       
//	        $("inpFrom").setStyle({
//	            width: (parseInt(windowDim.X) - 180) + "px"
//	        });
//	        $("rcbToGroup").setStyle({
//	            width: (parseInt(windowDim.X) - 175) + "px"
//	        });
...
//	        });
//	        $("inpMessage").setStyle({
//	            height: (windowDim.Y - 165 - 45) + "px",
//	            width: (parseInt(windowDim.X) - 180) + "px"
//	        });
//	        $("composeActions").setStyle({
//	            left: (parseInt(windowDim.X) / 2 - 75) + "px"
//	        });
	                    ...
	                    for (var i = 0; i < items.get_count(); i++) {
	                        ...
	                        if (item) {
	                            if (-1 != item.get_value() && 0 != item.get_value()) {
	                                EmailSystem.SendMessage(false, 0, userID, comboToGroupSelected.get_value(), item.get_value(), $F("inpSubject"), $F("inpMessage"), sendMessageCompleteAllRecepient, sendMessageAllError);
	                            }
	                        }
	                    }
	                } else {
	                    EmailSystem.SendMessage(false, 0, userID, comboToGroupSelected.get_value(), comboRecipientSelected.get_value(), $F("inpSubject"), $F("inpMessage"), sendMessageComplete, sendMessageError);
	                }
                }
            }
	    }
        ...
        <telerik:RadXmlHttpPanel runat="server" ID="Panel1">
	        <div id="TopMenuDiv" style ="background-color :White ; height:100%;">
	            ...
	            <div style ="position :absolute ; left :10px; top:40px">
	                ...
	                <telerik:RadComboBox ID="rcbToGroup" runat="server"  AllowCustomText="false" MarkFirstMatch ="false" EnableLoadOnDemand ="false" OnClientSelectedIndexChanged ="ToGroupChanged" TabIndex ="1" meta:resourcekey="rcbToGroupResource1"/>
	            </div>
	            <div style ="position :absolute ; left :10px; top:70px">
	                ...
	                <telerik:RadComboBox ID="rcbRecipient" runat="server" AllowCustomText="false" MarkFirstMatch ="false" EnableLoadOnDemand ="false" TabIndex ="2" meta:resourcekey="rcbRecipientResource1"/>
	            </div>
	                ...
	                <input type ="text" id="inpSubject" tabindex ="3"/>
	            </div>
                <div id="messageFormatDiv" runat ="server" class="MessageFormatDiv" style ="position :relative;left :10px; top:130px;">
	                ...
	                <textarea id="inpMessage" style ="overflow :auto;" tabindex ="4"></textarea>
	            </div>
