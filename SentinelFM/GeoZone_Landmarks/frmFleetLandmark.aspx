<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFleetLandmark.aspx.cs" Inherits="SentinelFM.Configuration.GeoZone_Landmarks_frmFleetLandmark" meta:resourcekey="PageResource1" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <table id="tblCommands" style="z-index: 101; left: 8px; position: absolute; top: 4px"
            ...
            <tr>
                <td>
                    <uc1:ctlMenuTabs ID="ctlMenuTabs1" runat="server" SelectedControl="cmdFleetLandmark" />
                </td>
            </tr>
            <tr>
                <td>
                                                                                ...
                                                                                <table id="Table7" style="width: 810px;" border="0">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="formtext" style="width: 136px" align="right">
                                                                                                                    <asp:Label ID="lblFleetTitle" runat="server" CssClass="formtext"
                                                                                                                        meta:resourcekey="lblFleetTitleResource6">Fleet:</asp:Label>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="width: 959px" align="center">
                                                                                            <table id="tblLandmarks" style="width: 663px; height: 362px" cellspacing="0" cellpadding="0"
                                                                                                        ...
                                                                                                        <table id="tblVehicles" style="width: 100%" cellspacing="0" cellpadding="0" border="0"
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="formtext" align="center">
                                                                                                                    <asp:Label ID="lblUnassignedLandmarks" runat="server" CssClass="formtext"
                                                                                                                        meta:resourcekey="lblUnassignedLandmarksResource6" Text="Unassigned Landmarks"></asp:Label></td>
                                                                                                                <td style="width: 106px" align="center"></td>
                                                                                                                <td class="formtext" align="center">
                                                                                                                    <asp:Label ID="lblAssignedLandmarks" runat="server" CssClass="formtext"
                                                                                                                        meta:resourcekey="lblAssignedLandmarksResource6" Text="Assigned Landmarks"></asp:Label></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td style="width: 30%" valign="top" align="left" height="257">
                                                                                                                    <asp:ListBox ID="lstUnAss" DataValueField="LandmarkId" DataTextField="LandmarkName"
                                                                                                                ...
                                                                                                                <td valign="top" align="center" width="30%" height="257">
                                                                                                                    <asp:ListBox ID="lstAss" DataValueField="LandmarkId" DataTextField="LandmarkName" CssClass="formtext"
