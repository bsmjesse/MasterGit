...
OpenLayers.Layer.Google.v3 = {
    ...
    */
    ...
    /**
    * APIProperty: disableTilt
    * {Boolean} If set to true, Google's 45-degree tilt view will be disabled.
    *     This is useful if you have planar overlays, and the tilt view is causing
    *     them not to overlay on the map features properly.
    *     Default is false, which allows 45-degree tilt.
    */
    disableTilt: false,
    ...
    */
    loadMapObject: function () {
        ...
        if (this.disableTilt) { mapObject.setTilt(0); }
