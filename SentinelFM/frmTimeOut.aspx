<%@ Page Language="c#" Inherits="SentinelFM.CaptchaTimeOut" ErrorPage="frmLoginError.aspx"
    CodeFile="frmTimeout.aspx.cs" Culture="en-US" meta:resourcekey="PageResource1"
    UICulture="auto" %>
    ...
    <form id="Login" name="Login" method="post" runat="server" autocomplete="OFF">
        <center>
            <div id="PageHeader" style="height: 100px;">
                <img src="images/TimeOut.gif" /><br /><asp:Label ID="lblSorry" runat="server" meta:resourcekey="lblSorryResource1"
                    Text="Sorry, for security reasons your session time has expired and you have been automatically logged out."></asp:Label><br><asp:Label
                        ID="lblRelogin" runat="server" meta:resourcekey="lblReloginResource1" Text="Please relogin to begin a new session."></asp:Label>&nbsp;</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:ValidationSummary ID="valSummary" runat="server" Width="100%" CssClass="errortext"
                                    Height="100%" meta:resourcekey="valSummaryResource1" Visible="False"></asp:ValidationSummary>
