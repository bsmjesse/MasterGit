<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FleetOrganizationHierarchy.ascx.cs" Inherits="SentinelFM.UserControl_FleetOrganizationHierarchy" %>
    ...
    <tr >
        ...
        <td align="left" >
            <asp:Label ID="lblOhTitle" runat="server" CssClass="formtext" 
                Text=" Hierarchy Node:" Width="98px"
...
<div id="organizationHierarchyTree" style="display:none;">
    ...
    <div>
        <asp:Button class="kd-button" ID="btnOk" runat="server" Text="Ok" OnClientClick="applyOrganizationHierarchy();" OnClick="btnOk_Click"/>
