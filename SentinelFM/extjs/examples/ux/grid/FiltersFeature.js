...
if (typeof ResFilterText == 'undefined')
        FilterText = 'Filters';
else
        FilterText = ResFilterText;
...
Ext.define('Ext.ux.grid.FiltersFeature', {
     ...
     */
    menuFilterText : FilterText, //'Filters',
    /**
    ...
    attachEvents: function() {
        ...
        // We create filters at the start instead of 
        me.createFilters();
        //and restoring manually saved state
    ...
    createFilters: function() {
        var me = this,
            hadFilters = false ,//me.filters.getCount(), // As suggested here changed by SHehul http://www.sencha.com/forum/showthread.php?137142
            grid = me.getGridPanel(),
