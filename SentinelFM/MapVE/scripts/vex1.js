            ...
            for (var i = 0; i < avlinfos.length - 1; i++) {
                ...
                try {
                    ...
                    switch (avlinfo[6])
                    {
                        ...
                        case "Untethered*":
                            color = "#dd00dd";
                            image = this.imgdir + "/" + "Untethered.png";
                        break;
                        case "Tethered":
                        case "Tethered*":
                            color = "#00dddd";
                            image = this.imgdir + "/" + "Tethered.png";
                        break;
                        case "Ignition ON":
                        case "Ignition ON*":
                        case "parked":
                        ...
                        case "Power Save*":
                            color = "#777777";
                            image = this.imgdir + "/" + "GreyCircle.png";
                            break;
                        case "Idling":
                        case "Idling*":
                        case "idling":
...
//                            {
                                color = "#EEEE00";
                                image = this.imgdir + "/" + "IdleCircle.png";
                            // }
                            break;
                        ...
                        case "N/A*":
                            color = "#000000";
                            image = this.imgdir + "/" + "UnknownCircle.png";
                            break;                                                    
                    } 
