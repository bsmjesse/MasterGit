<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmReports_new_hr.aspx.cs" Inherits="SentinelFM.Reports_frmReports_new"
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function OpenCreateWindow(validationGroup, hideButton) {
                    ...
                    if (hideButton == '<%= cmdPreviewFleetMaintenanceReportHide.ClientID%>')
                ...
                function CustomValidateDate(sender, args) {
                    ...
                    if (selectedReport == "21" || selectedReport == "23" || selectedReport == "41") {
                            ...
                            <td align="center">
                                ...
                                <fieldset>
                                    <table width="100%">
                                        <tr align="center">
                                            <td  align="center">
                                                <table   style="width:<%= tblWidth %> ;" cellspacing="0"
                                                 ...
                                                 <asp:CheckBox ID="chkShowDriver" runat="server" CssClass="formtext" Width="257px"
                                                    Text="Display Driver"></asp:CheckBox>
                                                                                            ...
                                                                                            <td>
                                                                                                <telerik:RadComboBox ID="cboViolationSpeed" runat="server" CssClass="formtext" Filter="Contains"
                                                                                                    ...
                                                                                                    <Items>
                                                                                                        ...
                                                                                                        <telerik:RadComboBoxItem Value="4" Text="120 kph (75 mph)"></telerik:RadComboBoxItem>
                                                                                                        <telerik:RadComboBoxItem Value="5" Text="130 kph (80 mph)"></telerik:RadComboBoxItem>
                                                                                                        <telerik:RadComboBoxItem Value="6" Text="140 kph (90 mph)"></telerik:RadComboBoxItem>
                                                                                                    </Items>
                                                                                                </telerik:RadComboBox>
                                                                                            </td>
                                                                                        </tr>
                                                    ...
                                                    <tr>
                                                                    ...
                                                                    <td colspan=2 >
                                                                        <asp:CheckBox ID="chkIsPostedOnly"  runat="server" 
                                                                            Text="Posted Road Speed Only" Checked="False" class="formtext" TextAlign="Left"
                                                                           /></td>
                                                      </tr>
                                                      <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <table id="tblFleetMaintenance" runat="server" class="formtext" border="0" cellpadding="0" width ="100%"
                                                                            cellspacing="0">
                                                                            <tr style="height: 2px">
                                                ...
                                                <input id="Radio2" type="radio" name="raVehicleSelectOption" value="2" runat="server" onclick="$('#trFleet').show();$('#organizationHierarchy').hide();">Fleet                                                --%>
                                                                ...
                                                                <tr id="trFleet" runat="server">
                                                                            ...
                                                                            <td class="formtext" style="width: 52px"><nobr>
                                                                                <asp:Label ID="lblVehicleName" runat="server" CssClass="formtextGreen"
