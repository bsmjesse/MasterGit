<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmReportMaster.aspx.cs"
    ...
    <style type="text/css">
       ...
       <script language="javascript">
           ...
           function inifiletree(inipath) {
               $('#vehicletreeview').fileTree({ root: '', script: 'vehicleListTree.asmx/FetchVehicleList', expanded: inipath, expandSpeed: 200, collapseSpeed: 200, vehicledetails: 'vehicledetails', highlightVehicleSelection: false },
               /*
...
<body>
    ...
    <form id="frmReportMaster" method="post" runat="server">
       <input type="hidden" name="OrganizationHierarchyNodeCode" id="OrganizationHierarchyNodeCode" />
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"  class="formtext">
                                        <tr>
                                            ...
                                            <td colspan="2" class="formtext" align="left" valign="top">
                                                ...
                                                <table id ="tbAuditReport" runat = "server" visible="false" >
                                                <tr>
                                                    <td align="left">
                                                ...
                                                <table id="tblViolationReport" cellspacing="0" cellpadding="0" border="0" runat="server">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="cboViolationSpeed" runat="server" CssClass="formtext" 
                                                                            ...
                                                                            <asp:ListItem Value="4" >115 kph (71 mph)</asp:ListItem>
                                                                            <asp:ListItem Value="5" >120 kph (75 mph)</asp:ListItem>
                                                                            <asp:ListItem Value="6" >125 kph (77 mph)</asp:ListItem>
                                                                            <asp:ListItem Value="7" >130 kph (80 mph)</asp:ListItem>
                                                                            <asp:ListItem Value="8" >140 kph (90 mph)</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                 ...
                                                 <table id="tblRoadSpeed" cellspacing="0" cellpadding="0" border="0" runat="server">
                                                    <tr>
                                                                    ...
                                                                    <td colspan=2 >
                                                                        <asp:CheckBox ID="chkIsPostedOnly"  runat="server"  Checked="true" Enabled="False"
                            ...
                            <tr>
                                <td colspan="5">
                                    <table width="100%" id="tblGeneralCriteria" runat="server">
                                        ...
                                        <tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td style="width: 100px">
                                                            <telerik:RadDatePicker ID="txtFrom" runat="server" Width="170px" DateInput-EmptyMessage=""
                                                        ...
                                                        <td style="width: 100px">
                                                            <asp:DropDownList ID="cboHoursFrom" runat="server" CssClass="RegularText" Width="64px"
                                                                Height="22px" meta:resourcekey="cboHoursFromResource1">
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td align="left">
                                                <table>
                                                    <tr>
                                                        <td style="width: 100px">
                                                            <%--<ISWebInput:WebInput ID="txtTo" runat="server" Width="182px" Height="17px" Wrap="Off">
                                                            ...
                                                            <telerik:RadDatePicker ID="txtTo" runat="server" Width="170px" DateInput-EmptyMessage=""
                                                        ...
                                                        <td style="width: 100px">
                                                            <asp:DropDownList ID="cboHoursTo" runat="server" CssClass="RegularText" Width="64px"
                                                                Height="22px" meta:resourcekey="cboHoursToResource1">
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <!-Devin Aecon Start-->
                            <tr runat="server" id= "trDispatch" visible= "false" >
                                                                        <td class="tableheading" style="width: 28px; height: 14px">
                                            </td>
                                            <td class="tableheading" style="width: 52px; height: 14px" align="left">
                                                <asp:Label ID="lblType" runat="server" CssClass="tableheading" Width="33px" meta:resourcekey="lblTypeResource1"
                                                    Text="Type:"></asp:Label>
                                            </td>
                               <td colspan="10" align="left">
                                   <asp:DropDownList runat="server" ID="radDispatch" >

                                       <asp:ListItem Text = "Excavator & Shovel Flag Sheets" Value= "0"   ></asp:ListItem>
                                       <asp:ListItem Text = "Haul Truck Flag Sheets" Value= "1" ></asp:ListItem>
                                       <asp:ListItem Text = "Report Structure" Value= "2" ></asp:ListItem>
                                       <asp:ListItem Text = "Loading Units Dispatch" Value= "3" ></asp:ListItem>
                                       <asp:ListItem Text = "Dump Location Dispatch" Value= "4" ></asp:ListItem>
                                   </asp:DropDownList>
                               </td>
                            </tr>
                                        ...
                                        <tr id="vehicleSelectOption" class="formtext"  runat="server">
                                            ...
                                            <td  class="formtext"   colspan="4">
                                                <table class="formtext" runat=server id="optBaseTable"  cellpadding=0 cellspacing=0  >
                                                    <tr>
                                                        <td> 
                                                            <asp:Label ID="Label11" runat="server" Text="Create Report Based On:" 
                                                   ...
                                                   <div id="RightPane">
                                                        <div id="vehicledetails">
                                                            <table cellspacing="0" class="vehiclelisttbl tablesorter" id="vehiclelisttbl">
                                                                <thead>
                                                                <tr>
                                                                    <th><asp:Label ID="Label12" runat="server" Text="Vehicle" 
                                                                            meta:resourcekey="Label12Resource1"></asp:Label></th>                                                                                                                                                                                                     
                                                                </tr>
                                                                </thead>
                                                                <tbody></tbody>
                                                            </table>
