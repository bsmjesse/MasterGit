<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmReportMasterExtendedNew.aspx.cs"
                                ...
                                <td colspan="5" style="height: 295px">
                                    ...
                                    <asp:DropDownList ID="cboReports" runat="server" AutoPostBack="True" CssClass="RegularText"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 100px">
                                                <telerik:RadDatePicker ID="txtFrom" runat="server" Width="258px" DateInput-EmptyMessage=""
                                            ...
                                            <td style="width: 100px">
                                                <telerik:RadDatePicker ID="txtTo" runat="server" Width="258px" DateInput-EmptyMessage=""
                               ...
                               <td colspan="10" align="left">
                                   <asp:DropDownList runat="server" ID="radDispatch" >
                                       ...
                                       <asp:ListItem Text = "Dump Location Dispatch" Value= "4" ></asp:ListItem>
                                          ...
                                          <tr id="vehicleSelectOption" class="tableheading"  runat="server">
                                            <td  class="tableheading"  style="height: 24px">
                                            </td>
                                            <td  class="tableheading"   colspan="4">
                                                <table class="tableheading" cellpadding=0 cellspacing=0  >
                                                    <tr>
                                                        <td> Create Report Based On: </td>
                                                        <td>
                                                                 <asp:RadioButtonList ID="optReportBased" name="ReportBased" runat=server  class="tableheading" 
                                        ...
                                        <tr ID="trFleet" runat="server">
                                            <td class="formtext" style="width: 28px; height: 14px">
                                            ...
                                            <td class="tableheading" style="height: 14px" align="left" colspan="2">
                                                ...
                                                <asp:Label ID="lblVehicleName" runat="server" CssClass="tableheading" Width="53px"
                                                    Visible="False" meta:resourcekey="lblVehicleNameResource1" Text="Vehicle:" Height="18px"></asp:Label>
                                            </td>
                                            <td class="tableheading">
