<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmReportMasterExtendedExt.aspx.cs"
    Inherits="SentinelFM.Reports_frmReportMasterExtendedExt" Culture="en-US" meta:resourcekey="PageResource1"
    UICulture="auto" %>
                            ...
                            <tr>
                                <td colspan="5" style="height: 295px">
                                    ...
                                    <asp:DropDownList ID="cboReports" runat="server" AutoPostBack="True" CssClass="RegularText"
                                        ...
                                        meta:resourcekey="cboReportsResource1" Width="258px">
                                    </asp:DropDownList></td>
                                            <td align="left" style="width: 100px">
                                            </td>
                                            <td align="left" style="width: 100px">
                               ...
                               <telerik:RadDatePicker ID="txtFrom" runat="server"  DateInput-EmptyMessage="" Width="100px" 
                               ...
                               <telerik:RadDatePicker ID="txtTo" runat="server"  DateInput-EmptyMessage="" Width="100px"  
                                    MinDate="01/01/1900" MaxDate="01/01/3000" Skin="Hay"  Culture="en-US" >
                                    ...
                                    <DateInput ID="DateInput2"  Culture="en-US"  runat="server" DateFormat="MM/dd/yyyy" DisplayDateFormat="MM/dd/yyyy" LabelCssClass="" >
                                    </DateInput>
                                    ...
                                    <!-- By Devin -->
                                    <asp:Panel ID="pnlWorkSite" runat="server" Visible="true">
                                        <tr>
                                            <td align="left" colspan="5">
                                                <asp:Label ID="lblEmailTitle" runat="server" CssClass="formtext" meta:resourcekey="lblRadiusTitleResource1"
                                                    Text="Email: (Please seperate multiple emails by semicolon)"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td colspan="5">
                                                <asp:TextBox ID="txtEmail" runat="server" CssClass="formtext" Width="600px" meta:resourcekey="txtEmaiiResource1"
                                                    MaxLength="4000" ></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rvtxtEmail" runat="server" ControlToValidate="txtEmail"
                                                    ErrorMessage="Please enter emails." meta:resourcekey="valRadiusResource1" Text="*"></asp:RequiredFieldValidator>
                                                <asp:CustomValidator ID="cvtxtEmails" runat="server" ControlToValidate="txtEmail"
                                                    Display="Dynamic" Text="*" ErrorMessage="Invalid emaill address or emails are not seperated by semicolon."
                        ...
                        <tr>
                            <td align="center" colspan="5">
                                <asp:RadioButtonList ID="lstAddOptions" runat="server" CssClass="formtext" Width="675px"
                                    ...
                                    <asp:ListItem Value="0" Selected="True" meta:resourcekey="lstAddOptionsListItemResource1"
                                        Text="By Street Address"></asp:ListItem>
                                    <asp:ListItem Value="1" meta:resourcekey="lstAddOptionsListItemResource2" Text="By Coordinates/Map"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr>
...
(
                            ...
                            <td style="width: 100px">
                                <asp:TextBox ID="txtRadius" runat="server" CssClass="formtext" Width="173px" meta:resourcekey="txtRadiusResource1">-1</asp:TextBox>
                            </td>
                            <td style="width: 100px">
                                <asp:RequiredFieldValidator ID="valRadius" runat="server" ControlToValidate="txtRadius"
                                    ErrorMessage="Please enter a Radius." meta:resourcekey="valRadiusResource1" Text="*"></asp:RequiredFieldValidator><asp:RangeValidator
                                        ...
                                        MaximumValue="9999999" MinimumValue="-1" meta:resourcekey="valRangeRadiusResource1"
                        ...
                        <asp:Panel ID="tblStreet" runat="server">
                            <tr>
                                <td style="width: 179px; height: 32px" align="left">
                                    <asp:Label ID="lblStreetTitle" runat="server" meta:resourcekey="lblStreetTitleResource1"
                                        Text="Street:"></asp:Label>
                                    <asp:RequiredFieldValidator ID="ValAddress" runat="server" CssClass="formtext" ControlToValidate="txtStreet"
                                        ErrorMessage="Please enter a Street Address" meta:resourcekey="ValAddressResource1"
                                ...
                                <td style="width: 195px; height: 32px">
                                    <asp:TextBox ID="txtStreet" runat="server" CssClass="formtext" Width="173px" TextMode="MultiLine"
                                        OnTextChanged="txtStreet_TextChanged" meta:resourcekey="txtStreetResource1"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td style="width: 99px; height: 32px">
                                    <asp:Label ID="lblCityTitle" runat="server" meta:resourcekey="lblCityTitleResource1"
                                        Text="City:"></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td style="width: 179px" align="left">
                                    <asp:Label ID="lblStateProvinceTitle" runat="server" meta:resourcekey="lblStateProvinceTitleResource1"
                                        Text="State (Prov):"></asp:Label>
                                </td>
                                <td style="width: 195px">
                                    <asp:TextBox ID="txtState" runat="server" CssClass="formtext" Width="173px" OnTextChanged="txtState_TextChanged"
                                        meta:resourcekey="txtStateResource1" Height="22px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td style="width: 99px">
                                    <asp:Label ID="lblCountryTitle" runat="server" meta:resourcekey="lblCountryTitleResource1"
                        ...
                        <tr>
                            <td class="style2" align="left">
                                <asp:Label ID="lblX" runat="server" CssClass="formtext" Visible="False" meta:resourcekey="lblXResource1"
                                    Text="Latitude (north is positive):"></asp:Label><asp:RequiredFieldValidator ID="valX"
                                        runat="server" CssClass="formtext" ControlToValidate="txtX" ErrorMessage="Please enter Latitude"
                                        Enabled="False" meta:resourcekey="valXResource1" Text="*"></asp:RequiredFieldValidator><asp:RangeValidator
                                            ...
                                            Type="Double" meta:resourcekey="valRangLatResource1" Text="*"></asp:RangeValidator>
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtY" runat="server" CssClass="formtext" Visible="False" name="txtY"
                                    meta:resourcekey="txtYResource1" Width="173px"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                            <td class="style1">
                                <asp:Label ID="lblY" runat="server" CssClass="formtext" Visible="False" meta:resourcekey="lblYResource1"
                                    Text="Longitude (west is negative):"></asp:Label><asp:RangeValidator ID="valRangeLong"
                                        runat="server" CssClass="errortext" ControlToValidate="txtY" ErrorMessage="Longitude is wrong."
                                        MaximumValue="90" MinimumValue="-90" Enabled="False" Type="Double" meta:resourcekey="valRangeLongResource1"
                                        Text="*"></asp:RangeValidator><asp:RequiredFieldValidator ID="valY" runat="server"
                                            CssClass="formtext" ControlToValidate="txtY" ErrorMessage="Please enter Longitude"
                                            Enabled="False" meta:resourcekey="valYResource1" Text="*"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:TextBox ID="txtX" runat="server" CssClass="formtext" Visible="False" name="txtX"
                                    meta:resourcekey="txtXResource1" Width="173px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5" align="center">
                                <asp:RadioButtonList ID="LandmarkOptions" runat="server" CssClass="formtext" Width="250px"
                                    BorderWidth="0px" Enabled="false" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="0" Selected="True" Text="Circle"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Rectangle"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Polygon"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <asp:Panel ID="tblShowMap" runat="server">
                            <tr>
                                <td colspan="5" align="center" width="100%">
                                    <a class="link" onclick="ShowMapCall()" href="#">
                                        <asp:Label ID="lblViewMapTitle" runat="server" meta:resourcekey="lblViewMapTitleResource1"
                                            Text="View map"></asp:Label></a>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
                            <td colspan="5" align="center">
                                <asp:DataGrid ID="dgLandmarkCoordinates" Visible="false" runat="server" Width="100%"
                                    AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"
                                    BorderColor="#E0E0E0" BorderStyle="Solid" BorderWidth="1px" meta:resourcekey="dgGeoZonesCoordinatesResource1">
					...
					<TABLE id="tblFleets" cellSpacing="0" cellPadding="0" border="0" runat="server">
                        ...
                        <tr>
                            <td align = "center" colspan="5">
                                <asp:Button ID="cmdExecute" runat="server" CssClass="combutton" meta:resourcekey="cmdExecuteResource1"
                                    OnClick="cmdExecute_Click" Text="Execute" Width="178px" Visible="false" />
                                <asp:Button ID="btnBack" runat="server" CssClass="combutton" meta:resourcekey="btnBackResource1" ValidationGroup="NoValidate"
                                    Text="Back" Width="178px" Visible="false" PostBackUrl="../History/frmhistmain_new.aspx" />
    ...
    <script type="text/javascript">
        ...
        function ShowMapCall() {
            ...
            $.ajax({
                ...
                url: "frmReportMasterExtendedExt.aspx/SetSearchMap",
                data: postData,
                dataType: "json",
    ...
    <asp:Button ID="btnHidden" runat="server" Width="0px" Height="0px" Style="display: none"
        OnClick="btnHidden_Click" ValidationGroup="NoGroup" />
