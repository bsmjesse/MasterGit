<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmHistMap.aspx.cs" Inherits="SentinelFM.History_frmHistMap"
...
<body bgcolor="white" onload="init();initToolTips();" style="width: 100%" rightmargin="0">
    ...
    <div class="skin0" id="ie5menu" onmouseover="highlightie5(event)" style="z-index: 135;
        left: 118px; position: absolute; top: 45px; display: none;"
    ...
    <div id="rubberBandLayer" style="z-index: 102; left: 70px; position: absolute; top: 5px;
    ...
    <img id="imgMap" style="border-right: gray 3px double; border-top: gray 3px double;
        z-index: 101; left: 70px; border-left: gray 3px double; border-bottom: gray 3px double;
        position: absolute; top: 5px; height: 325px" height="325px" src="<%=sn.History.ImgPath%>"
