<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmHistoryMapVE.aspx.cs" Inherits="SentinelFM.History_frmHistoryMapVE" %>
...
<body onload="GetMap('History');frameSize();" onresize="frameSize();">
    <form id="MapForm">
