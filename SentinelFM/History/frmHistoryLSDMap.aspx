<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmHistoryLSDMap.aspx.cs" Inherits="SentinelFM.History_frmHistoryLSDMap" %>
...
<head runat="server">
    ...
    <style type="text/css">
        #cache { Z-INDEX: 10; LEFT: 10px; VISIBILITY: hidden; POSITION: absolute; TOP: 200px }
    </style>
    <style type="text/css">
        .trans { FILTER: alpha(opacity=50); BACKGROUND-COLOR: whitesmoke; moz-opacity: 0.5 }
    ...
    <script language="JavaScript" type="text/javascript" >
        ...
        function SearchWindow() { 
		    var mypage="../Map/frmMapSearch.aspx?frm='../History/frmHistoryLSDMap.aspx'"
			var myname='';
			var w=580;
			var h=450;
...
<body onload="init();initToolTips();" style="width:100%; background-color:White"  rightmargin="0">
    <form id="frmHistory" method="post" runat="server">
        <table id="Table3" style="z-index: 106; left: 185px;  
                                ...
                                <table style="border-right: 1px outset; border-top: 1px outset; border-left: 1px outset; border-bottom: 1px outset">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="height: 19px">
                                                        <asp:ImageButton ID="btnMoveNorth" runat="server" border="0" ImageUrl="~/images/icon_go_up.gif" OnClick="btnMoveNorth_Click" meta:resourcekey="btnMoveNorthResource2" ToolTip="Move map north"/>
                                                    </td>
                                                    <td style="height: 19px"></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:ImageButton ID="btnMoveWest" runat="server" border="0" ImageUrl="~/images/icon_go_left.gif" OnClick="btnMoveWest_Click" meta:resourcekey="btnMoveWestResource2" ToolTip="Move map west"/>
                                                    </td>
                                                    <td style="background-color: white"></td>
                                                    <td>
                                                        <asp:ImageButton ID="btnMoveEast" runat="server" border="0" ImageUrl="~/images/icon_go_right.gif" OnClick="btnMoveEast_Click" meta:resourcekey="btnMoveEastResource2" ToolTip="Move map east"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <asp:ImageButton ID="btnMoveSouth" runat="server" border="0" ImageUrl="~/images/icon_go_down.gif" OnClick="btnMoveSouth_Click" meta:resourcekey="btnMoveSouthResource2" ToolTip="Move map south" CausesValidation="False" EnableViewState="False"/>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="width: 61px" align="center">
                                           <asp:ImageButton ID="cmdZoomInMain" runat="server" border="0" ImageUrl="../images/plusImg.gif" OnClick="cmdZoomInMain_Click" EnableViewState="False" CausesValidation="False" meta:resourcekey="cmdZoomInMainResource1" ToolTip="Zoom In"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px" align="center">
                                            <asp:Button ID="btnMaxZoom" runat="server" Height="10px" Width="20px" ForeColor="Silver" OnClick="btnMaxZoom_Click" meta:resourcekey="btnMaxZoomResource2"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px" align="center">
                                            <asp:Button ID="btnStreetLevel1" runat="server" Height="10px" Width="20px" OnClick="btnStreetLevel1_Click" meta:resourcekey="btnStreetLevel1Resource2"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px" align="center">
                                            <asp:Button ID="btnStreetLevel2" runat="server" Height="10px" Width="20px" OnClick="btnStreetLevel2_Click" meta:resourcekey="btnStreetLevel2Resource2"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px" align="center">
                                           <asp:Button ID="btnRegionLevel1" runat="server" Height="10px" Width="20px" OnClick="btnRegionLevel1_Click" meta:resourcekey="btnRegionLevel1Resource2"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px; height: 12px;" align="center">
                                            <asp:Button ID="btnRegionLevel2" runat="server" Height="10px" Width="20px" OnClick="btnRegionLevel2_Click" meta:resourcekey="btnRegionLevel2Resource2"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px" align="center">
                                            <asp:Button ID="btnCountryLevel" runat="server" Height="10px" Width="20px" OnClick="btnCountryLevel_Click" meta:resourcekey="btnCountryLevelResource2"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 61px" align="center">
                                            <asp:ImageButton ID="cmdZoomOutMain" runat="server" border="0" ImageUrl="../images/minusImg.gif" OnClick="cmdZoomOutMain_Click" EnableViewState="False" CausesValidation="False" meta:resourcekey="cmdZoomOutMainResource1" ToolTip="Zoom Out"/>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table style="border-right: 1px outset; border-top: 1px outset; border-left: 1px outset; border-bottom: 1px outset">
                                    ...
                                    <tr>
                                        <td style="width: 100px" align="center">
                                            <asp:ImageButton ID="cmdRecenter" runat="server" border="0" ImageUrl="~/images/rctf.gif" OnClick="cmdRecenter_Click" meta:resourcekey="cmdRecenterResource2" ToolTip="Re-Center"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100px"></td>
                                    ...
                                    <tr>
                                        <td style="width: 100px" align="center">
                                            <asp:ImageButton ID="cmdMapOpt" runat="server" border="0" ImageUrl="~/images/mapOpts.gif" OnClientClick="MapOptions()" meta:resourcekey="cmdMapOptResource2" ToolTip="Map Options"/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100px" align="center">
                                            <img id="Img1" alt="" src="../images/resizemp.gif" onclick="ResizeMap()" runat="server"/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
        ...
        <table style="border-right: 1px outset; border-top: 1px outset; border-left: 1px outset;border-bottom: 1px outset">
            <tr>
                <td align="left" >
                    <asp:CheckBoxList ID="chkLayers" runat="server" CssClass="formtext" Width="98%" BorderStyle="Solid" BorderWidth="1px">
                        <asp:ListItem Value="2" Selected="True" Text="Roads"/>
                        <asp:ListItem Value="6" Selected="True" Text="Wells"/>
                        <asp:ListItem Value="7" Selected="True" Text="Pipelines"/>
                        <asp:ListItem Value="8" Selected="True" Text="LP pipelines"/>
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
                <td align="left">
                    <asp:Button ID="cmdUpdateView" runat="server" CssClass="combutton" meta:resourcekey="cmdCancelUpdatePosResource1" OnClick="cmdUpdateView_Click" Text="Update View" Width="91px"/>
                    &nbsp;&nbsp;
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center">
                    <table>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="lblSector" runat="server" CssClass="formtext" Text="Section:"/>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSection" runat="server" CssClass="formtext" Width="70px"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="lblTownship" runat="server" CssClass="formtext" Text="Township:"/>
                            </td>
                            <td>
                                <asp:TextBox ID="txtTownship" runat="server" CssClass="formtext" Width="70px"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="lblRange" runat="server" CssClass="formtext" Text="Range:"/>
                            </td>
                            <td>
                                <asp:TextBox ID="txtRange" runat="server" CssClass="formtext" Width="70px"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="Label1" runat="server" CssClass="formtext" Text="Meridian:"/>
                            </td>
                            <td>
                                <asp:TextBox ID="txtMeridian" runat="server" CssClass="formtext" Width="70px"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 3px; height: 21px;">
                                <asp:Label ID="Label2" runat="server" CssClass="formtext" Text="Quarter:"/>
                            </td>
                            <td style="height: 21px">
                                <asp:DropDownList ID="cboQuarter" runat="server" CssClass="formtext" Width="69px">
            ...
            <tr>
                <td align="left">
                    <asp:Button ID="cmdDisplay" runat="server" CssClass="combutton" meta:resourcekey="cmdCancelUpdatePosResource1" OnClick="cmdDisplay_Click" Text="Go" Width="91px"/>
                    &nbsp;&nbsp;&nbsp;
                </td>
            </tr>
        </table>
        <div class="skin0" id="ie5menu" onmouseover="highlightie5(event)" style="z-index: 135;
            left: 118px; position: absolute; top: 45px; display :none" onclick="jumptoie5(event)" onmouseout="lowlightie5(event)">
            <div class="menuitems">
                 <asp:LinkButton ID="btnSearch" Text="Search" OnClientClick="SearchWindow();" runat="server"/>
            </div> 
    ...
    <form name="myform">
        ...
        <div id="toolTipLayer" style="font-weight: normal; font-size: small; z-index: 198;
            visibility: hidden; width: 1px; color: gray; font-family: Tahoma, Arial; position: absolute;height: 17px">
        </div>
        <img id="imgMap" alt="" style="border-right: gray 3px double; border-top: gray 3px double;
            z-index: 101; left: 250px; border-left: gray 3px double; border-bottom: gray 3px double;
            position: absolute; top: 5px; height: 325px" src="<%=sn.History.ImgPath%>" width="<%=imageW%>"
    ...
    <map id="locations" name="locations">
