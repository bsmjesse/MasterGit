<%@ Page Language="c#" Inherits="SentinelFM.History.frmHistoryLegend" CodeFile="frmhistoryMapsoluteLegend.aspx.cs" Culture="en-US" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <form method="post" runat="server">
        <table class="formtext" id="Table1" style="z-index: 101; left: 8px; width: 200px;
            ...
            <tr>
                ...
                <td class="heading" style="width: 28px">
            ...
            <tr>
                ...
                <td class="heading" style="width: 28px"></td>
            </tr>
            <tr>
                ...
                <td align="left">
                    <asp:Image ID="Image1" runat="server" ImageUrl="../Bigicons/Stop_3.ico" meta:resourcekey="Image1Resource1" ImageAlign="Left"></asp:Image>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left">
                   &nbsp;<asp:Image ID="Image2" runat="server" ImageUrl="../Bigicons/Stop_15.ico" meta:resourcekey="Image2Resource1"></asp:Image>
                </td>
            </tr>
            <tr>
                <td style="width: 183px"></td>
            ...
            <tr>
                ...
                <td align="left">
                   &nbsp;<asp:Image ID="Image3" runat="server" ImageUrl="../Bigicons/Stop_60.ico" meta:resourcekey="Image3Resource1"></asp:Image>
                </td>
            </tr>
            <tr>
                <td style="width: 183px"></td>
            ...
            <tr>
                ...
                <td align="left" >
                    <asp:Image ID="Image4" runat="server" ImageUrl="../Bigicons/Idle.ico" meta:resourcekey="Image4Resource1" ImageAlign="Left"></asp:Image>
                </td>
            </tr>
            <tr>
                <td style="width: 183px"></td>
