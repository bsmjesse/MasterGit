<%@ Page language="c#" Inherits="SentinelFM.frmFleetVehicles" CodeFile="frmFleetVehicles.aspx.cs" Culture="en-US" meta:resourcekey="PageResource1" UICulture="auto" %>
																					...
																					<TABLE id="Table7" class=table HEIGHT="500px" WIDTH="960px"
																						...
																						<TR id="trBasedOnNormalFleet" runat="server">
																							<TD align="center" class="configTabBackground">
																								<uc1:ctlFleetVehicles id="CtlFleetVehicles1" runat="server"></uc1:ctlFleetVehicles></TD>
																						</TR>
