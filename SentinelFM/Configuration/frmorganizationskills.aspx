<%@ Page language="c#" Inherits="SentinelFM.frmorganizationskills" CodeFile="frmorganizationskills.aspx.cs" Culture="en-US" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<HTML>
  <head id="Head1" runat="server">
		<title>Organization Skills</title>
        ...
        <script src="../DriverFinder/Scripts/ManageSkills.js" type="text/javascript"></script>
        <style>
		body { font-size: 62.5%; }
																			...
																			<TR>
																				<TD valign=top>
																					<TABLE id="Table7" class=table HEIGHT="500px" WIDTH="960px" border="0">
																						<TR>
																							<TD valign=top>
                                                                                                <table id="OrganizationSkillsTable" cellpadding="0" cellspacing="0" border="0" class="display">
                                                                                                    <thead>
                                                                                                            <tr>
                                                                                                                <th>Skill name</th>
                                                                                                                <th>Description</th> 
                                                                                        ...
                                                                                        <tr>
                                                                                        <td align=center>
                                                                                            <asp:Button ID="btnAddNewSkill" runat="server" Text="Add new skill"  CssClass="confbutton" OnClientClick="return false;"/>                                                                                            
                                                                                        </td>
                                                                                        </tr>
																					</TABLE>
																				</TD>
...
<div id="dialog-form" title="Create new skill">
<p class="validateTips"></p>
	<fieldset>
		<label for="name">Skill Name</label>
		<input type="text" name="txtSkillName" id="txtSkillName" class="text ui-widget-content ui-corner-all" />
