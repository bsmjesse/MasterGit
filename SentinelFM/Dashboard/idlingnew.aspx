<%@ Page Language="C#" AutoEventWireup="true" CodeFile="idlingnew.aspx.cs" Inherits="DashBoard_idlingnew" %>
...
<%--    <link rel="stylesheet" type="text/css" href="shared/example.css" />--%>
             ...
             Ext.define('IData',
               {
                   ...
                   fields: ['description', 'idling', 'fuel', 'perc', 'TotalIdling', 'TotalFuel']
               }
               );
   ...
   var store1 = new Ext.data.Store(
   {
       ...
       proxy: new Ext.ux.AspWebAjaxProxy(
      {
          url: './dashboardService.asmx/LoadIdlingDetails',
          timeout: 120000,
   ...
   var store2 = new Ext.data.Store(
   {
    ...
    handler: function() {
       window.open('reportViewer.aspx?reportId=3&fleetId='+cbofleets.value+'&data='+cboHrs.value,'Report','left=20,top=20,width=700,height=700,toolbar=1,resizable=1');
