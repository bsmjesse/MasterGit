<%@ Page Language="C#" AutoEventWireup="true" CodeFile="maintenancenew.aspx.cs" Inherits="DashBoard_maintenancenew" %>
...
<%--    <link rel="stylesheet" type="text/css" href="shared/example.css" />--%>
   ...
   var store1 = new Ext.data.Store(
   {
    ...
    handler: function() {
       window.open('../Maintenance/frmMaintenanceGrid.aspx?DashBoardFleetID='+cbofleets.value,'Maintenance','left=20,top=20,width=1230,height=800,toolbar=1,resizable=1');
   ...
   var store2 = new Ext.data.Store(
   {
    ...
    var barChart = Ext.create('widget.panel', {
        ...
        layout: 'fit',
        tbar: [cbofleets,{ xtype: 'tbfill' },cmdReport],
        items: {
            xtype: 'chart',
            id: 'chartCmp',
            animate: true,
