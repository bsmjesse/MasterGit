...
namespace BSM.VE.Ajax
{
    ...
    public class AjaxService : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public string GetLandmarksWithBoundaries(int organizationIdentifier, float topleftlat, float topleftlon, float bottomrightlat, float bottomrightlon)
        {
        ...
        [WebMethod]
        public string GetGeozonesWithBoundaries(int organizationIdentifier, float topleftlat, float topleftlon, float bottomrightlat, float bottomrightlon)
        {
            string csv = string.Empty;
            try
            {
        ...
        [WebMethod]
        public string GetPoisWithBoundaries(int organizationIdentifier, float topleftlat, float topleftlon, float bottomrightlat, float bottomrightlon)
        {
            string csv = string.Empty;
            return csv;
        }
