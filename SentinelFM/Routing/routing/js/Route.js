...
g(document).ready(function() {
    ...
    g('#gpx_button').on("click", function() {
       ...
       // g(".ui-dialog-buttonpane button:contains('Edit an skill') span").text("Edit a route");
       // g(".ui-dialog-buttonpane button:contains('Delete an skill') span").text("Delete a route");
    });
...
***/        
    ...
    function ValidateForm() {
        ...
        console.log(g.trim(g('#txtEmail').val()));
