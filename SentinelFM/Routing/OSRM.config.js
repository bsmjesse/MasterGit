...
OSRM.DEFAULTS = {
	...
	NAVTEQ_ROUTING_ENGINES: [
	    {
	        url: 'http://router.project-osrm.org/viaroute',
	        timestamp: 'http://router.project-osrm.org/timestamp',
	        metric: 0,
	        label: 'NavTEQ_ENGINE_0'
	    },
	    {
	        url: 'http://router.project-osrm.org/viaroute',
	        timestamp: 'http://router.project-osrm.org/timestamp',
	        metric: 0,
	        label: 'NavTEQ_ENGINE_1'
	    },
	    {
	        url: 'http://router.project-osrm.org/viaroute',
	        timestamp: 'http://router.project-osrm.org/timestamp',
	        metric: 0,
	        label: 'NavTEQ_ENGINE_2'
	    }
	],
	...
	ONLOAD_ZOOM_LEVEL: 4,
	ONLOAD_LATITUDE: 43.67746,
	ONLOAD_LONGITUDE: -79.5850766666667,
	ONLOAD_SOURCE: "",
	ONLOAD_TARGET: "",
	...
	TILE_SERVERS: [
        {
            display_name: 'NavTeq Map',
            url: 'http://' + Math.floor((Math.random() * 3) + 1) + '.base.maps.api.here.com/maptile/2.1/maptile/newest/normal.day/{z}/{x}/{y}/256/png8?app_id=v5HljYEynPujgUUkNmny&app_code=x14y1MmQaoSerjNQKGsABw',
            attribution: 'Map data &copy; 2012 NavTeq contributors, Imagery &copy',
            options: { maxZoom: 18 }
        },
        /***
	    {
	...
	NOTIFICATIONS: {
		LOCALIZATION:	undefined, //1800000,	// 30min
		CLICKING: 		undefined, //60000,		// 1min
		DRAGGING: 		undefined, //120000,		// 2min 
		MAINTENANCE:	false
	},
