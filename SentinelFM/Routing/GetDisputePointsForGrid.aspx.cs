...
public partial class Routing_GetDisputesPointForGrid : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int totalCount = 0;        
        IList<Dictionary<string, string>> recordData = PostGisLandmark.GetDisputePointsForGrid(conditions, sn.User.OrganizationId, ref totalCount);
