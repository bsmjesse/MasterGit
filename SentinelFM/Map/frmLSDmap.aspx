<%@ Page Language="c#" Inherits="SentinelFM.frmLSDmap"   CodeFile="frmLSDmap.aspx.cs" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
function ResizeMap()
{
   parent.frmVehicleMap.location.href="frmLSDmap.aspx?clientWidth="+document.body.clientWidth+"&clientHeight="+document.body.clientHeight; 
...
function up(e){
  ...
  getMouse(e);
	...
	{
		if (event.button==1)
			parent.frmVehicleMap.location.href="frmLSDmap.aspx?CoordInX="+document.myform.imagex.value+"&CoordInY="+document.myform.imagey.value+"&CoordEndX="+document.myform.imageEndx.value+"&CoordEndY="+document.myform.imageEndy.value; 
	}
	else
	{
		if (e.which==1)
...
//-->
    ...
    <script language="javascript">
    	...
    	{
    		parent.frmVehicleMap.location.href="frmLSDmap.aspx?CoordInX=0&CoordInY=0&CoordEndX=0&CoordEndY=0" ; 
    	}
    	
    	function ReloadMap(CoordX,CoordY)
    	{
    		parent.frmVehicleMap.location.href="frmLSDmap.aspx?CoordX="+CoordX+"&CoordY="+CoordY ; 
    	}
    		...
    		function MapOptions() { 
				...
				function SearchWindow() { 
					var mypage="frmMapSearch.aspx?frm='frmLSDmap.aspx'"
					var myname='';
					var w=580;
					var h=450;
					var winl = (screen.width - w) / 2; 
...
<body bgcolor="white" onload="init();initToolTips();" style="width:100%"  rightmargin=0>
    <form id="frmVehicleMapForm" method="post" runat="server">
                   ...
                   <tr>
                      <td align="center" style="width: 53px; height: 21px;">
                         <table style="border-right: 1px outset; border-top: 1px outset; border-left: 1px outset;
                            ...
                            <tr>
                               <td style="width: 100px" align="center">
                                  <img src="../images/resizemp.gif" onclick="ResizeMap()" runat=server   alt="<%$ Resources:ResizeMap %>"  /></td>
                            </tr>
                         </table>
                      </td>
                   </tr>
        ...
        <table style="border-right: 1px outset; border-top: 1px outset; border-left: 1px outset;border-bottom: 1px outset">
            <tr>
                <td align="center" >
                    <asp:CheckBoxList ID="chkLayers" runat="server" CssClass="formtext" Width="98%" BorderStyle="Solid" BorderWidth="1px" >
                        <asp:ListItem Value="2" Selected="True">Roads</asp:ListItem>
                        <asp:ListItem Value="6" Selected="True">Wells</asp:ListItem>
                        <asp:ListItem Value="7" Selected="True">Pipelines</asp:ListItem>
                        <asp:ListItem Value="8" Selected="True">LP pipelines</asp:ListItem>
                    </asp:CheckBoxList></td>
            </tr>
            <tr>
                <td align="left">
                    <asp:Button ID="cmdUpdateView" runat="server" CssClass="combutton" meta:resourcekey="cmdCancelUpdatePosResource1"
                        OnClick="cmdUpdateView_Click" Text="Update View" Width=91px  />
                    &nbsp;&nbsp;
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" >
                    <table>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="lblSector" runat="server" CssClass="formtext" Text="Section:"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtSection" runat="server" CssClass="formtext" Width=70px></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="lblTownship" runat="server" CssClass="formtext" Text="Township:"></asp:Label></td>
                            <td><asp:TextBox ID="txtTownship" runat="server" CssClass="formtext" Width=70px></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="lblRange" runat="server" CssClass="formtext" Text="Range:"></asp:Label></td>
                            <td><asp:TextBox ID="txtRange" runat="server" CssClass="formtext" Width=70px ></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 3px">
                                <asp:Label ID="Label1" runat="server" CssClass="formtext" Text="Meridian:"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtMeridian" runat="server" CssClass="formtext" Width="70px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 3px; height: 21px;">
                                <asp:Label ID="Label2" runat="server" CssClass="formtext" Text="Quarter:"></asp:Label></td>
            ...
            <tr>
                <td align="left">
                    <asp:Button ID="cmdDisplay" runat="server" CssClass="combutton" meta:resourcekey="cmdCancelUpdatePosResource1"
                        OnClick="cmdDisplay_Click" Text="Go" Width=91px  />&nbsp;&nbsp;&nbsp;</td>
            </tr>
    ...
    <form name="myform">
        ...
        <img id="imgMap" style="border-right: gray 3px double; border-top: gray 3px double;
            ...
            position: absolute; top: 5px; height: 315px" height="325px" src="<%=sn.Map.ImgPath%>"
    ...
    <div class="trans" id="selectLayer" style="border-right: black 1px dashed; border-top: black 1px dashed;
        font-size: 0px; z-index: 199; visibility: hidden; border-left: black 1px dashed;
...
<script language="JavaScript">
			...
			function jumptoie5(e)
			{
				...
				if (firingobj.className=="menuitems"||ns6&&firingobj.parentNode.className=="menuitems")
				{
					...
					{
						parent.frmVehicleMap.location.href="frmLSDmap.aspx?ZoomIn="+firingobj.getAttribute("jsZoom");
					}
