<%@ Page Language="c#" Inherits="SentinelFM.Map.frmMapVehicleSearch" CodeFile="frmMapVehicleSearch.aspx.cs"
            ...
            <tr>
                <td style="width: 473px;" valign="top">
                    ...
                    <asp:DropDownList ID="cboSearchType" runat="server" AutoPostBack="True" CssClass="RegularText"
                        ...
                        <asp:ListItem Value="2" meta:resourcekey="ListItemResource3" Text="Landmark"></asp:ListItem>
                        <asp:ListItem Value="3" meta:resourcekey="ListItemResource4" Text="Unit ID"></asp:ListItem>
                    ...
                    <asp:TextBox ID="txtSearchParam" runat="server" CssClass="formtext" 
                        meta:resourcekey="txtSearchParamResource1" onkeypress="return clickButton(event,'cmdSearch')"></asp:TextBox></td>
                        </tr>
                    </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 308px" valign="top">
                                            <asp:DropDownList ID="cboDistanceAdrSrc" runat="server" CssClass="RegularText" Width="173px"
                                                Height="14px" meta:resourcekey="cboDistanceAdrSrcResource1">
                          ...
                          <td style="width:  110%" valign="top">
                             <table id="tblIntersection" runat="server" style="width:  100%;" class="formtext" >
                                ...
                                <tr>
                                  ...
                                  CssClass="combutton" Text="Find By Location" meta:resourcekey="cmdFindAddress"
