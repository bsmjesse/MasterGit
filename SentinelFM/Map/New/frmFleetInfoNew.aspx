<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFleetInfoNew.aspx.cs"
    Inherits="SentinelFM.Map_Telerik_frmFleetInfoNew" Culture="en-US" meta:resourcekey="PageResource2"
    UICulture="auto" %>
...
<body id="body" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0">
  ...
  {%>
    ...
    OrganizationHierarchyPath = "<%=OrganizationHierarchyPath %>";
        ...
        var DefaultOrganizationHierarchyMultipleFleetIds = '<%=DefaultOrganizationHierarchyMultipleFleetIds %>';
        ...
        {            
            ...
            $('#<%=BarItembtnOrganizationHierarchyNodeCode.ClientID %>').val(fleetName); 
            
            $find("<%= RadAjaxManager1.ClientID %>").ajaxRequest("RebindOrganizationHierarchyFleet");          
        }
                                        ...
                                        <tr>
                                                        ...
                                                        <telerik:RadToolBarButton Text="barFleet">
                                                            <ItemTemplate>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lblFleetTitle" Text="Fleet:" ForeColor="White" runat="server" CssClass="RegularText"
                                                                                meta:resourcekey="MenuItemResource3"></asp:Label>
                                                                            <asp:Label ID="lblOhTitle" runat="server" CssClass="formtext" Text=" Hierarchy Node:" Visible="false" />
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <asp:Button ID="cmdCancelUpdatePos" runat="server" CssClass="combutton" Text="Cancel"
                                                                OnClientClick="javascript:CancelUpdatePos();return false;" meta:resourcekey="cmdCancelUpdatePosResource1"></asp:Button>
                                                        </td>
                                                        <td style="width: 10px" align="center">&nbsp;
                                                        </td>
                                                        <td align="center">
                                            ...
                                            <td align="right">
                                                <table>
                                                    <tr>
                                                        <td valign="middle">
                                                            <asp:LinkButton ID="imgExport" runat="server" OnClientClick="javascript:return showExport(event);" Text="Export" ForeColor="White" CssClass="RegularText" Font-Underline="true" meta:resourcekey="imgExport" />
                                                        </td>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function MapitByVehicleIDs(vehicleIDs)
                {
                    ...
                    $telerik.$.ajax({
                        ...
                        url: "frmFleetInfoNew.aspx/MapitByVehicleIDs",
                        data: postData,
                        dataType: "json",
            ...
            function chkSelectAllVehicles_Click() {
             ...
             function chkSelectVehicle_Click(itemID, ctl) {
                ...
                <%if (sn.User.LoadVehiclesBasedOn == "hierarchy")
                  { %>
                var fleetID = $('#<%=hidOrganizationHierarchyFleetId.ClientID %>').val();
                <%} %>
                <%else
                  { %>
            ...
            function UpdatePosition(ctl)
            {
                ...
                {	
                    alert('<%=  GetScriptEscapeString((string)base.GetLocalResourceObject("sn_MessageText_SelectOne")) %>'); 
                    return;	
                }
                var postData = "{'vehicleIDs':'," + vehicleIDs +  ",'}";
