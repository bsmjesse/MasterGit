...
namespace SentinelFM
{
    ...
    public partial class Map_Telerik_fleetInfo : SentinelFMBasePage
    {
        ...
        ////Return JSON string
        public static string SaveShowCheckBoxes_2(string vehicleIDs, Boolean isCheckTime, SentinelFMSession snP)
        {
            ...
            foreach (DataRow rowItem in snP.Map.DsFleetInfoNew.Tables[0].Rows)
            {
        ...
        public static string MapIt2(string vehicleIDs)
        {
            ...
            try
            {
                string result=SaveShowCheckBoxes_2(vehicleIDs, true, sn);
                return result;
            }
            catch (Exception ex)
            {
