<%@ Page Language="c#" Inherits="SentinelFM.frmSensorsInfo" CodeFile="frmSensorsInfo.aspx.cs"
...
<head runat="server">
    ...
    <script>
        (function () {
            ...
            document.write('<scr' + 'ipt src="js/lhgdialog.min.js?skin=' + (_skin || 'default') + '"></sc' + 'ript>');
            window._isDemoSkin = !!_skin;
        })();

        function OpenWiFiSettingWindow() {
            var boxId = document.getElementById("txtCommandBoxId").value;
            $.dialog({
                title: 'Wi-Fi Setting Parameters',
                width: '440px',
                height: '400px',
                content: 'url:frmWiFiSettings.aspx' + '?boxId=' + boxId
            });
        }
    </script>
  </head>
                                    ...
                                    <tr>
                                        <td align="center" class="configTabBackground">
                                            <table id="Table1" style="border-top-width: thin; border-left-width: thin; border-left-color: gray;
                                              ...
                                              <table id="tblWiFiUpgrade" style="width: 384px" cellspacing="0" cellpadding="0" width="384" border="0" runat="server">
                                                    <tr>
                                                        <td colspan="2"  class="formtext">
                                                              <asp:Label ID="lblLinuxWiFiBoxModel" runat="server" ForeColor="Red"></asp:Label>
                                                        </td>
                                                    </tr>
                                                               <tr>
                                                                <td class="formtext" style="width: 100px;padding:3px;" align="left" colspan="1">
                                                                    <asp:Label ID="lblWiFiSettings" runat="server" Text="Wi-Fi Command:"></asp:Label>
                                                                   </td>
                                                                <td style="width: 240px;padding:3px;text-align:left;">
                                                                    <asp:DropDownList ID="selectWiFiUpgradeFileType" runat="server" CssClass="RegularText" Width="200px" OnSelectedIndexChanged="selectWiFiUpgradeFileType_SelectedIndexChanged1" AutoPostBack="True">
                                                                    ...
                                                                    <asp:TextBox ID="txtCommandBoxId" runat="server" Width="50px" cssClass="textHidden"></asp:TextBox>
                                                              ...
                                                              <tr>
                                                                <td class="formtext" style="width: 100px" align="left" colspan="1">
                                                                    <asp:Label ID="lblWiFiUpgradeParam" runat="server" data-event="test" Text="Parameter:"></asp:Label>
                                                                    <asp:Label ID="cmdOpenWifiSettings" runat="server" CssClass="labelButton" Text="..." ToolTip="Click to set parameters" Visible="False"></asp:Label>
                                                                 </td>
                                                                <td style="width: 240px;padding:3px; text-align:left;">
                                                                    <asp:TextBox ID="txtWiFiUpgradeOutput" runat="server" CssClass="formtext" Width="237px"></asp:TextBox>
                                                                    <asp:Label ID="lblWiFiUpgradeOutput" runat="server" CssClass="wifiWiFiOutputButton" Text="..." ToolTip="Click to build parameters"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table id="tblPowerOffDelay" style="width: 384px" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <table ID="tblEEPROMFeature" runat="server" style="width: 384px" 
                                                            cellspacing="0" cellpadding="0"
                                                            width="384" border="0">
                                                                
                                                            <tr>
                                                                <td>
                                                                   <asp:Label ID="lblEEPROMFeature" runat="server" Text="Configure EEPROM Feature" style="font-size:10px;" class="runcode"></asp:Label>
                                                                   </td>
                                                                <td>
                                                                    
                                                                    <asp:DropDownList ID="cboEEPromFeature" runat="server" 
                                                                        onselectedindexchanged="cboEEPromFeature_SelectedIndexChanged"  AutoPostBack="True">
                                                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                                                        <asp:ListItem Value="1">Enable Buzzer</asp:ListItem>
                                                                        <asp:ListItem Value="2">Disable Buzzer</asp:ListItem>
                                                                    </asp:DropDownList>
                                                            ...
                                                            <tr id="tblRowBuzzerOutput" align="left">
                                                                <td>
                                                                   <asp:Label ID="lblBuzzerOutput" runat="server" Text="Buzzer Output" style="font-size:10px;" ></asp:Label>
                                                                   </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtBuzzerOutput" runat="server" CssClass="formtext" 
                                                                        Width="50px" ontextchanged="txtBuzzerOutput_TextChanged" 
                                                                        AutoPostBack="True" >2</asp:TextBox>
                                                           ...
                                                           <tr>
                                                              <td align="left" class="formtext" colspan="1" style="width: 152px">
                                                                 <asp:Label ID="lblEEPROMData" runat="server" CssClass="formtext" 
                                                                    Text="Data:" meta:resourcekey="lblEEPROMDataResource1"></asp:Label>
                                                                    </td>
                                                              <td align="left">
                                                                ...
                                                                <td>
                                                                    <div id="divsetup" title="Box Setup:" style="border-right: gray thin outset; border-top: gray thin outset;
                                                                       ...
                                                                       <table runat=server class="formtext" id="tblViolations" width="359px"  >
                                                                        ...
                                                                        select<asp:DataGrid ID="dgBoxSetupSensors" runat="server" Width="358px" AutoGenerateColumns="False"
...
<script type="text/javascript">
    $("#lblWiFiUpgradeOutput").click(function () {
        var boxId = document.getElementById("txtCommandBoxId").value;
        $.dialog({
            title: 'Wi-Fi Setting Parameters',
            width: '440px',
    ...
    $("#btnOpenWinParam").click(function () {
        var boxId = document.getElementById("txtCommandBoxId").value;
        $.dialog({
            title: 'Wi-Fi Setting Parameters',
            width: '440px',
