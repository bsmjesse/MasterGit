<%@ Page Language="c#" Inherits="SentinelFM.frmAlarmRotating" CodeFile="frmAlarmRotating.aspx.cs" Culture="en-US" meta:resourcekey="PageResource1" Async="true"   UICulture="auto" CompilerOptions="/d:ASYNC" %>
...
<body bgcolor="white" onload="start();">
    <form id="WebForm1" method="post" runat="server">
        <table class="tableDoubleBorder"  style=" z-index: 101; left: 0px; position: absolute; top: 4px; width: 100%" align="left" border="0">
            <tr>
                <td class="hbg" style="border-bottom: black 1px outset">
