<%@ Page Language="c#" Inherits="SentinelFM.frmBigMap" CodeFile="frmBigMap.aspx.cs" Culture="en-US" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    ...
    <script language="JavaScript">
            ...
            function ResizeMap()
            {
               window.location.href="frmbigmap.aspx?clientWidth="+document.body.clientWidth+"&clientHeight="+document.body.clientHeight; 
			...
			getMouse(e);
				...
				if (event.button==1)
					window.location.href="frmBigMap.aspx?CoordInX="+document.myform.imagex.value+"&CoordInY="+document.myform.imagey.value+"&CoordEndX="+document.myform.imageEndx.value+"&CoordEndY="+document.myform.imageEndy.value; 
    ...
    <script language="javascript">
		...
		if (ie)
    	{
			...
			if (ver >= 4)
    		{
    		document.write('<DIV ID="cache" style="Z-INDEX: 104; LEFT: 500px; POSITION: absolute; TOP: 300px"><TABLE WIDTH=800 BGCOLOR=#4682b4 BORDER=0 CELLPADDING=2 CELLSPACING=0><TR><TD ALIGN=center VALIGN=middle><TABLE WIDTH=100% BGCOLOR=#FFFFFF BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD ALIGN=center VALIGN=middle><FONT FACE="Arial, Verdana" SIZE=4 color="#003366"><B><BR>PLEASE WAIT ... <BR><BR></B></FONT></TD> </TR></TABLE></TD> </TR></TABLE></DIV>');
    ...
    function cacheOff()
    	...
    	{
    		window.location.href="frmBigMap.aspx?CoordInX=0&CoordInY=0&CoordEndX=0&CoordEndY=0" ; 
    	}
    	
    	function ReloadMap(CoordX,CoordY)
    	{
    		window.location.href="frmBigMap.aspx?CoordX="+CoordX+"&CoordY="+CoordY ; 
    	}
    
    
		function MapOptions() { 
					var mypage='frmBigMapOptions.aspx'
					var myname='';
					var w=230;
					var h=200;
...
<body onload="cacheOff();init();initToolTips();">
    <form id="frmBigMapForm" method="post" runat="server">
       
       
        <table id="Table2" style="z-index: 111; left: 0px;  width: 63px;position: absolute; top: 0px; height: 629px;" height="629"
            cellspacing="0" cellpadding="0" width="89" bgcolor="white" border="0">
            
            <tr>
                <td  align="center" valign=top   background="verticalgray">
                         ...
                         <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                               ...
                               <tr>
                                   <td align="center" style="width: 61px; height: 21px">
                            <asp:ImageButton ID="cmdRecenter" runat="server" border="0" ImageUrl="~/images/rctf.gif"
                               OnClick="cmdRecenter_Click" meta:resourcekey="cmdRecenterResource2" ToolTip="Re-Center" /></td>
                               </tr>
                               <tr>
                                   <td style="width: 61px; height: 21px" align="center">
                            <asp:ImageButton ID="cmdMapOpt" runat="server" border="0" ImageUrl="~/images/mapOpts.gif"
                               OnClientClick="MapOptions()" meta:resourcekey="cmdMapOptResource2" ToolTip="Map Options" /></td>
                               </tr>
                               <tr>
                                   <td align="center" style="width: 61px; height: 21px">
                                       <img id="Img1"  onclick="ResizeMap()"
                                           src="../images/resizemp.gif" runat=server   alt="<%$ Resources:ResizeMap %>" /></td>
                               </tr>
                                  </table>
    ...
    <form name="myform">
        ...
        <div class="trans" id="selectLayer" style="border-right: black 1px dashed; border-top: black 1px dashed;
            font-size: 0px; z-index: 108; visibility: hidden; border-left: black 1px dashed;
            border-bottom: black 1px dashed; position: absolute">
        </div>
        <div style="z-index: 106; left: 80px; width: 846px; position: absolute; top: 0px;
            height: 624px" align="left">
            <div id="toolTipLayer" style="font-weight: bold; font-size: medium; z-index: 121;
                visibility: hidden; color: blue; font-family: Tahoma, Arial; position: absolute">
            </div>
            <img id="imgMap" style="border-right: gray 4px double; border-top: gray 4px double;
                left: 30px; border-left: gray 4px double; border-bottom: gray 4px double;
                top: 0px;" height="<%=imageH%>" src="<%=ViewState["imgPath"]%>" width="<%=imageW%>"
                usemap="#locations">
        </div>
    </form>
    ...
    <script language="JavaScript"><!--
			...
			function toolTip(indexList)
			{
				...
				bg = "white"; 
				var content =
				'<table border="1" cellspacing="0" cellpadding="1" bgcolor="' + bg + '" width="300" bordercolor="black"><tr>' +
			...
			else
			{
				...
				if (y + toolTipLayer.offsetHeight> height) {
    ...
    <div class="skin0" id="ie5menu" onmouseover="highlightie5(event)" style="z-index: 125;
    ...
    <script language="JavaScript">
			...
			function jumptoie5(e)
			{
				...
				if (firingobj.className=="menuitems"||ns6&&firingobj.parentNode.className=="menuitems")
				{
					...
					{
						parent.frmBigMap.location.href="frmBigMap.aspx?ZoomIn="+firingobj.getAttribute("jsZoom");
					}
