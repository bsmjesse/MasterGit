...
function FrameResize(owidth, oheight){
    GetFrameWidth();
    GetFrameHeight();
    vexwidth = vexwidth + owidth;
    vexheight = vexheight + oheight;
    //alert(w+ "\r\n" + h);
	if (document.all) {
		document.getElementById("vex").style.width = vexheight + "px";
		document.getElementById("vex").style.height = vexheight + "px";
	}else{
		document.getElementById("vex").style.width = vexheight + "px";
		document.getElementById("vex").style.height = vexheight + "px";		
	}
