<%@ Page Language="C#" AutoEventWireup="true" Async="true"  CodeFile="frmMessageRotatingClient.aspx.cs" Inherits="SentinelFM.Map_frmMessageRotatingClient" %>
...
<head>
    ...
    var sheight=<%=MDTMessagesScrollingHight%>//105;
...
function ReloadMessages()
    {
     new Ajax.Request('frmMessageRotatingServer.aspx', {
                evalJS: false,
     ...
     function handler(transport) {
         ...
         if (temp[1]!=undefined)
            document.getElementById('lblTotalMsgs').innerHTML =temp[1];
            else
         ...
         window.setTimeout("ReloadMessages()",30000); 
...
<body bgcolor="white" onload="ReloadMessages();start();">
            ...
            <tr>
                 <td style="border-bottom: black 1px outset;color:White;background-repeat: repeat;background-color:<%=headerColor%>" bgcolor="gray">
                    ...
                    <asp:Label ID="lblMessageTitle" runat="server" meta:resourcekey="lblMessageTitleResource1">Messages (24 hr) Total:</asp:Label>
                         <label  id="lblTotalMsgs" name="lblTotalMsgs"/></font></td>
            </tr>
            <tr>
                <td bgcolor="white">
