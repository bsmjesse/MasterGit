...
Ext.onReady(function ()
{
   ...
   var selModel = Ext.create('Ext.selection.CheckboxModel',
   {
      listeners :
      {
         selectionchange : function(selModel, selections)
         {
            ...
            {
               console.log("Error in selModel " + err);
            }
         }
      }
   }
   ...
   function onMapDataReceived(operation)
   {
      ...
      {
         console.log("Error in onMapDataReceived" + err);
         mapLoading = false;
      }
   }
   ...
   function onMapDataUpdate(operation)
   {
      ...
      {
         console.log("Error in onMapDataUpdate" + err);
         mapLoading = false;
      }
   }
   ...
   function mapVehicles(map, vehicleIDs, isInitial, mapJsonData, zoomVehicles)
   {
      ...
      {
         console.log("Error in mapVehicles" + err);
         mapLoading = false;
      }
   }
   function onZoomDataUpdate(operation)
   {
      ...
      {
         console.log("Error in onZoomDataUpdate" + err);
         mapLoading = false;
      }
   }
   ...
   function onUpdatePositionReceived(operation)
   {
      ...
      {
      console.log("Error in onUpdatePositionReceived" + err);
      }
   }
   ...
   function onTrackDataReceived(operation)
   {
      ...
      {
      console.log("Error in onTrackDataReceived" + err);
      }
   }
   var mapit = Ext.create('Ext.Button',
   {
      ...
      handler : function()
      {
         ...
         {
           console.log("Error in mapit" + err);
            mapLoading = false;
         }
      }
   }
   ...
   var updatePosition = Ext.create('Ext.Button',
   {
      ...
      handler : function()
      {
         ...
         {
           console.log("Error in updatePosition" + err);
         }
      }
   }
   );
   ...
   var trackit = Ext.create('Ext.Button',
   {
      ...
      handler : function()
      {
         ...
         {
          console.log("Error in trackit" + err);
         }
      }
   }
   );
   ...
   var demomap = Ext.create('Ext.Button',
   {
      ...
      handler : function()
      {
         ...
         {
         console.log("Error in demomap" + err);
         }
      }
   }
   );
   ...
   var searchMap = Ext.create('Ext.Button',
   {
      ...
      handler : function()
      {
         ...
         {
          console.log("Error in searchMap" + err);
         }
      }
   }
   );
   ...
   var mainstore = Ext.create('Ext.data.Store',
   {
      ...
      listeners :
      {
         'load' : function(store, records, options)
         {
            ...
            {
              console.log("Error in mainstore" + err);
            }
 ...
 // create the Data Store
   var fleetstore = Ext.create('Ext.data.Store',
   {
      ...
      listeners :
      {
         'load' : function(store, records, options)
         {
            ...
            {
            console.log("Error in fleetstore" + err);
            }
         }
         ,
         scope : this
   ...
   var fleets = Ext.create('Ext.form.field.ComboBox',
   {
      ...
      listeners :
      {
         ...
         'select' : function(combo, value)
         {
            ...
            {
             console.log("Error in fleets" + err);
            }
            currentState = LoadStates.MainStoreLoaded;
         }
      }
   ...
   var tabs = Ext.createWidget('tabpanel',
   {
      ...
      listeners :
      {
         tabchange : function(tabPanel, newTab)
         {
            ...
            {
            console.log("Error in tabs panel" + err);
            }
         }
      }
      ,
   ...
   var alarmtask =
   {
      run : function ()
      {
          console.log("Status " +  alarmsstore.isLoading() + " ActiveTab " + activetab + " Currrent State " + currentState);
         if(alarmsstore.isLoading() != true && activetab == ActiveTabs.Alarms && currentState == LoadStates.AlarmsLoaded)
         {
            ...
            {
            console.log("Error in alarmtask" + err);
            }
            //                 console.log('Shehul');
         }
      }
      ...
      onProxyLoad : function(operation)
      {
         ...
         {
                     console.log("Error in alarmtask onProxyLoad" + err);
         }
         currentState = LoadStates.AlarmsLoaded;
      }
      ,
   ...
   var vehicletask =
   {
      run : function ()
      {
        console.log("Status " +  mainstore.isLoading() + " ActiveTab " + activetab + " Currrent State " + currentState);
         if( ! mainstore.isLoading() && ! mapLoading  && activetab == ActiveTabs.Vehicles && currentState == LoadStates.MainStoreLoaded)
         {
            ...
            if(IsSyncOn)
            {
               ...
               {
                  console.log("Error in vehicletask" + err);
               }
            }
         }
      }
