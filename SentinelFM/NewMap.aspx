...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./sencha/Ext.ux.container/ButtonSegment.css" />
    ...
    <style type="text/css">
        ...
        .latereceived .x-date-time {background-color: #6A5ACD !important; color: White !important;}
...
//                var e=$(this);
//                //alert(hasVehiclePopover);
//                if(hasVehiclePopover)
//                    return;
//               

//                var title = e.attr('data-title') + '<button type="button" class="close" onclick="closebootstrappopover(this);hasVehiclePopover=false;">&times;</button>';
//                //alert(title);

//                if(e.attr('data-content') == 'loading...')
//                {
//                    $.get(e.data('poload'),function(d) {
//                        e.attr('data-content', d);
//                        
...
//         });
         ...
         /*$('[rel=bootstrapvehiclegridpopover]').popover({ 
            trigger: "hover",
            content:function(){
                var e=$(this);
            ...
            title : function() {
                var e=$(this);
                return e.attr('data-title') + '<button type="button" class="close" onclick="closebootstrappopover(this);">&times;</button>';
            },
