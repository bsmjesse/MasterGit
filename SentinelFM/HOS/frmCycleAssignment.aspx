<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCycleAssignment.aspx.cs" Inherits="SentinelFM.HOS_frmCycleAssignment" %>
...
<body>
    ...
    var PreferOrganizationHierarchyNodeCode = "<%=PreferOrganizationHierarchyNodeCode %>";
        var cyclesJson = <%=cyclesJson%>;
        var cyclesAssignedJson = "";
        ...
        function inifiletree(inipath, appendpath) {
            ...
            */
                    ...
                    function FillCycleList()
                    {
                        $("#<%= lstForms.ClientID %>").empty()
                        $("#<%= lstassignedForms.ClientID %>").empty()
                        if (cyclesJson.length > 0)
                        {
                            var var_groupIds = "";
                            if (cyclesAssignedJson.length > 0)
                            {
                                for(var index=0; index < cyclesAssignedJson.length; index++)
                                {
                                    $("#<%= lstassignedForms.ClientID %>").append($('<option></option>').attr('value', cyclesAssignedJson[index]["Rule"]).text(cyclesAssignedJson[index]["Name"]));
                                    var_groupIds = var_groupIds + "," + cyclesAssignedJson[index]["Rule"];
                                }
                            }
                            var_groupIds = var_groupIds + "," ;
                            for(var index=0; index < cyclesJson.length; index++)
                            {
                                var searchMatch = $.trim($("#txtSearchQuestionSet").val());
                                if ((searchMatch == "" || cyclesJson[index]["Name"].toLowerCase().indexOf(searchMatch.toLowerCase()) == 0) && var_groupIds.indexOf(cyclesJson[index]["Rule"]) < 0 )
                                {
                                    $("#<%= lstForms.ClientID %>").append($('<option></option>').attr('value', cyclesJson[index]["Rule"]).text(cyclesJson[index]["Name"]));
                                }
                            }
                        }
        ...
        function getAssignedCycle()
        {
            $('#lblErrorMessage').html('');
            if (currentSelectionFleet == "")
            {
            ...
            $.ajax({
                ...
                url: "frmCycleAssignment.aspx/GetCycleAndExceptionByHierarchy",
                data: JSON.stringify({
                ...
                success: function (data) {
                    if (data.d != '-1' && data.d != "0") {
                        if (data.d.length > 0)
                        {
                            cyclesAssignedJson = JSON.parse(data.d);
                        }
                        else cyclesAssignedJson = "";
                    }
                    FillCycleList();
                    if (data.d == '-1') {
            ...
            function AddOrUpdateLogData_CycleAssignment(isAdd)
            {
                $('#lblErrorMessage').html('');
                if (currentSelectionFleet == "")
                {
            ...
            $.ajax({
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                url: "frmCycleAssignment.aspx/AddOrUpdateLogData_CycleAndExceptionpAssignment",
                data: JSON.stringify({
                    rule:var_groupid,
                    currentSelection: currentSelectionFleet,
                    isBox: isBox,
                ...
                <tr align="left">
                    <td>
                        <table id="Table2" align="left" border="0" cellpadding="0" cellspacing="0" width="990">
                            <tr>
                                <td>
                                    <uc2:HosTabs ID="HosTabs1" runat="server" selectedcontrol="cmdCycleAssignemt" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                                                                                                                    ...
                                                                                                                                                    <tr>
                                                                                                                                                        <td>
                                                                                                                                                            <table>
                                                                                                                                                                <tr>
                                                                                                                                                                    <td>
                                                                                                                                                                        <asp:Label ID="lblAssignedto" runat="server" CssClass="formtextGreen" Font-Bold="true" Text="Select a cycle or exception assign to:" meta:resourcekey="lblAssigntoResource1"></asp:Label>
                                                                                                                                                                    </td>
                                                                                                                                                                    <td>
                                                                                                                                                                ...
                                                                                                                                                                <tr>
                                                                                                                                                                    ...
                                                                                                                                                                    <td>
                                                                                                                                                                        <table>
                                                                                                                                                                            <tr>
                                                                                                                                                                                <td>
                                                                                                                                                                                    <asp:Button Width="100px" ID="btnAssign" runat="server" Text="Assign" meta:resourcekey="btnAssignResource1" OnClientClick="javascript:AddOrUpdateLogData_CycleAssignment(true);return false;" />
                                                                                                                                                                                </td>
                                                                                                                                                                            </tr>
                                                                                                                                                                            <tr>
                                                                                                                                                                                <td>&nbsp;</td>
                                                                                                                                                                            ...
                                                                                                                                                                            <tr>
                                                                                                                                                                                <td>
                                                                                                                                                                                    <asp:Button Width="100px" ID="btnUnassign" runat="server" Text="UnAssign" meta:resourcekey="btnUnassignResource1" OnClientClick="javascript:AddOrUpdateLogData_CycleAssignment(false);return false;" />
                                                                                                                                                                                </td>
                                                                                                                                                                            </tr>
                                                                                                                                                                        </table>
                                                                                                                                                                    </td>
                                                                                                                                                                    <td>
                                                                                                                                                                        <table>
                                                                                                                                                                            <tr>
                                                                                                                                                                                <td>
                                                                                                                                                                                    <div class="formtext">
                                                                                                                                                                                        <asp:Label ID="lblAssignedQuestionSet" runat="server" CssClass="formtextGreen" Text="Assigned cycle or exception" meta:resourcekey="lblAssignedQuestionSetResource1"></asp:Label>
                                                                                                                                                                                    </div>
                                                                                                                                                                                </td>
                                                                                                                                                                            </tr>
                                                                                                                                                                            <tr>
