...
public partial class ServiceAssignment_LandmarkIdHelper : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int totalCount = 0;
        IList<Dictionary<string, string>> recordData = ServiceAssignment.GetFilteredLandmarks(conditions, sn.User.OrganizationId, sn.UserID, ref totalCount);
