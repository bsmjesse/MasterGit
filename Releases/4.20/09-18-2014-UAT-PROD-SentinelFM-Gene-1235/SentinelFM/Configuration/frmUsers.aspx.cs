    ...
    public partial class frmUsers : SentinelFMBasePage
    {
        ...
        private void DgUsers_Fill()
        {
            try
            {
                ...
                if (objUtil.ErrCheck(dbo.GetUsersInfoByOrganizationByLang(sn.UserID, sn.SecId, sn.User.OrganizationId, System.Globalization.CultureInfo.CurrentUICulture.TwoLetterISOLanguageName, ref xml), false))
                    if (objUtil.ErrCheck(dbo.GetUsersInfoByOrganizationByLang(sn.UserID, sn.SecId, sn.User.OrganizationId, System.Globalization.CultureInfo.CurrentUICulture.TwoLetterISOLanguageName, ref xml), true))
                    {
                        this.dgUsers.DataSource = null;
                        this.dgUsers.DataBind();
        ...
        protected void cmdSaveUser_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.lblUserId.Text == "0") // add new user
                {
                    ...
                    {
                        this.lblMessage.Text = (string)base.GetLocalResourceObject("msgWeakPassword");
                        this.lblMessage.Visible = true;
                        return;
                    }
        ...
        protected void dgUsers_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            else if (this.lblUserStatusText.Text == "Deactivated" || this.lblUserStatusText.Text == "Deleted" || this.lblUserStatusText.Text == "Désactivé" || this.lblUserStatusText.Text == "Effacé")
            {
