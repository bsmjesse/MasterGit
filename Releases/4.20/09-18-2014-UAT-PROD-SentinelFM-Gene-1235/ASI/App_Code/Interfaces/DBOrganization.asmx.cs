...
namespace VLF.ASI.Interfaces
{
    ...
    public class DBOrganization : System.Web.Services.WebService
    {
        ...
        public int GetOrganizationLandmarksXMLByOrganizationId(int userId, string SID,
                             ...
                             bool warning, bool critical, bool autoAdjustDayLightSaving, int speed, bool publicGeozone)
        {
            try
            {
                ...
                using (Organization dbOrganization = new Organization(LoginManager.GetConnnectionString(userId)))
                {
                    dbOrganization.AddGeozone(organizationId, geozoneName, type, geozoneType, dsGeozoneSet, severityId, description, email, phone, timeZone, dayLightSaving, formatType, notify, warning, critical, autoAdjustDayLightSaving, speed, publicGeozone);
                }
                                ...
                                bool critical, bool autoAdjustDayLightSaving, bool publicGeozone)
        {
            try
            {
                ...
                using (Organization dbOrganization = new Organization(LoginManager.GetConnnectionString(userId)))
                {
                    dbOrganization.UpdateGeozone(organizationId, geozoneId, geozoneName, type, geozoneType, dsGeozoneSet, severityId, description, email, phone, timeZone, dayLightSaving, formatType, notify, warning, critical, autoAdjustDayLightSaving, publicGeozone);
                }
        ...
        public int GetUsersInfoByOrganization(int userId, string SID, int organizationId, ref string xml)
        {
            try
            {
                ...
                using (Organization dbOrganization = new Organization(LoginManager.GetConnnectionString(userId)))
                {
                    dsInfo = dbOrganization.GetUsersInfoByOrganization(userId, organizationId);
                }
