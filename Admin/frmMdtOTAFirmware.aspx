<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMdtOTAFirmware.aspx.cs" Inherits="SentinelFM.Admin.frmMdtOTAFirmware" %>
                                                                ...
                                                                <td align="center" class="formtext" style="width: 100%">
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 100px"><asp:Button ID="cmdRefreshBoxFirmware" runat="server" CssClass="combutton" OnClick="cmdRefreshBoxFirmware_Click"
                                                                                    Text="Refresh  Firmware Status" Width="156px" /></td>
                                                                            <td style="width: 100px">
                                        ...
                                        <td align="center" colspan="2" style="width: 587px; height: 370px" valign="top">
                                            <asp:DataGrid ID="dgData" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn Visible="true"  HeaderText="UPG Firmware">
                                                        <ItemStyle Width="100px" Wrap="False" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblNewFirmware" runat="server" Text='<%#  DataBinder.Eval(Container.DataItem,"UPGFirmwareType") %>'>
																</asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:DropDownList ID="cboUPGFirmwareType" runat="server" DataSource='<%# dsUPGFirmwareType%>'
                                                                DataTextField="UPGFirmwareType" DataValueField="UPGFirmwareType" SelectedIndex='<%# GetUPGFirmwareType(Convert.ToString(DataBinder.Eval(Container.DataItem,"UPGFirmwareType")))%>'>
                                                            </asp:DropDownList>
                                                        </EditItemTemplate>
                                                    </asp:TemplateColumn>
